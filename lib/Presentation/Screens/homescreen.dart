...
import 'package:todo1/Presentation/Screens/search.dart';
import 'package:todo1/Presentation/Screens/tas.dart';
import 'package:todo1/Presentation/Screens/tasklist.dart';
          ...
          child: FloatingActionButton(
            onPressed: () {
              TaskModel newTask = TaskModel(
                id: 0,
                // Set an appropriate ID for the new task (or get it from your database logic)
                task: '',
                date: '',
            ...
            children: [
              Padding(
                ...
                child: Text(
                  _selectedOption ??
                      'Custom Title',
                  // Set app bar title to selected dropdown item
            ...
            IconButton(
                ...
                onPressed: () async {
                  int? selectedIndex = await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CustomSearchScreen(tasks: _tasks),
                    ),
                  );
                }
              //      onPressed: () async {
              //         await showSearch(
              //           context: context,
              //           delegate: CustomSearchDelegate(tasks: _tasks,),
              //         );
              //       },
            ),
